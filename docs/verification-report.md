...
- Replies/analytics UI smoke: passed in the local browser. `/replies` shows 33 outbound records, 5 threads/messages, 4 bounces, 1 out-of-office, and the Add Letter Reply form. `/analytics` shows 33 outbound, 8 email, 25 letters, 0 human replies, 0 letter replies, 4 bounces, 0% response rate, and 12.1% bounce rate.
