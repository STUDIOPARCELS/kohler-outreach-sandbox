...
const NICHE_PERSONAL: Record<string, string> = {
  ...
  "Acoustics / Audio / Musical Instruments": "I've studied and performed classical piano for three years and built an adaptive bass guitar as my senior capstone.",
...
const NICHE_BODY_TEMPLATES: Record<string, string> = {
  ...
  "Acoustics / Audio / Musical Instruments": nicheTemplate(
    "I've studied and performed classical piano for three years and built an adaptive bass guitar as my senior capstone."
  ),
