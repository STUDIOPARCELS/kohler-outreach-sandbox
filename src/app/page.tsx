                                                  ...
                                                  <div className="flex items-start justify-between gap-2">
                                                    <div className="min-w-0 flex-1">
                                                      ...
                                                      <div className="flex items-center gap-2 mt-1 flex-wrap">
                                                        ...
                                                        {job.source && <span className="text-[10px] text-gray-400">{job.source}</span>}
                                                      </div>
                                                      {job.summary && <p className="text-[10px] text-gray-500 mt-1 line-clamp-2 leading-relaxed">{job.summary}</p>}
                                                    </div>
                                                    <a
                                                      href={job.apply_url}
                                                      target="_blank" rel="noopener noreferrer"
