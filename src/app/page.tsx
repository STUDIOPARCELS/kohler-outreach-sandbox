...
const NICHE_BODY_TEMPLATES: Record<string, string> = {
  ...
  "Woodworking / Furniture / Cabinetry / Prototyping": nicheTemplate(
    "I spent the last year designing and fabricating woodworking projects, including a Frank Lloyd Wright-style record cabinet — the chance to apply my engineering skills to this craft would be a dream come true."
  ),
