...
const NICHE_SEARCH_TERMS: Record<string, string[]> = {
  ...
  "Energy / Renewables / Power": ["power engineering firm", "energy infrastructure engineering", "renewable energy mechanical engineering"],
  "Metals / Material Science": ["precision machining company", "metal fabrication engineering", "additive manufacturing company"],
  "Manufacturing / Automation / Product Design": ["mechanical design engineering company", "industrial automation engineering", "manufacturing engineering company"],
  "Quantum / Deep Tech / Electronics / Robotics": ["robotics engineering company", "mechatronics company", "electromechanical systems engineering"],
  "Construction / Civil / Heavy Industry": ["mechanical contractor engineering", "design build mechanical contractor", "construction engineering firm"],
  "MEP / HVAC / Building Systems": ["MEP engineering firm", "HVAC mechanical engineering", "building systems engineering firm"],
  "Water / Environmental / Geotech": ["water wastewater engineering firm", "environmental engineering mechanical", "water infrastructure engineering"],
  "Aerospace / Space": ["space systems company", "aerospace mechanical engineering", "satellite manufacturer", "rocket propulsion company"],
    ...
    const searchRes = await fetch(`${RR_BASE}/v2/api/search`, {
      ...
      body: JSON.stringify({
        query: {
          ...
          current_title: [
            "Mechanical Engineering Manager", "Engineering Manager", "Director of Engineering",
            "VP of Engineering", "Head of Engineering", "Chief Engineer", "MEP Manager",
            "HVAC Engineering Manager", "Mechanical Department Manager", "Mechanical Principal",
            "Principal Mechanical Engineer", "Licensed Mechanical Engineer", "Professional Engineer",
            "Mechanical PE", "Senior Mechanical Engineer", "R&D Manager", "Plant Manager",
            "Product Development Manager", "Manufacturing Manager", "Design Engineering Manager",
          ],
          location: ["Colorado"],
        },
        start: 1,
    ...
    if (mode === "manual") {
      ...
      try {
        ...
        const mgmtPatterns = [
          ...
          /plant manager/i, /superintendent/i, /professional engineer/i,
